      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Gestão de estoque inteligente para empresas que querem crescer com eficiência e lucratividade.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#pricing" className="hover:text-primary transition-smooth">Preços</a></li>
              <li><a href="#" className="hover:text-primary transition-smooth">Integrações</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-smooth">Documentação</a></li>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © 2025 EstoquePro. Todos os direitos reservados.
          </p>
          <div className="flex gap-6">
            ...
            <a href="https://www.instagram.com/lazaro_scolari" className="text-muted-foreground hover:text-primary transition-smooth">
